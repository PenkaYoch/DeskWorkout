...
import bg.deskworkout.deskworkout.ui.createWorkout.CreateWorkoutFragment
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab.setOnClickListener { view ->
            ...
            navController.navigate(R.id.createWorkoutFragment)
...
//                    .setAction("Action", null).show()
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.nav_home, R.id.nav_feedback, R.id.nav_settings
            ), drawerLayout
        )

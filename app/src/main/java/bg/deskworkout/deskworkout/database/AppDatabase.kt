...
import bg.deskworkout.deskworkout.utils.SingletonHolder
...
private val CREATE_EXERCISES_TABLE_SQL = """CREATE TABLE ${ExerciseDB.TABLE_NAME} (
    ${ExerciseDB.Columns.ID} INTEGER PRIMARY KEY AUTOINCREMENT,
    ${ExerciseDB.Columns.NAME} VARCHAR(50) NOT NULL,
    ${ExerciseDB.Columns.IMAGE_NAME} VARCHAR(50) NOT NULL,
    ${ExerciseDB.Columns.DESCRIPTION} VARCHAR(200) NOT NULL)""".replaceIndent(" ")
...
internal class AppDatabase (context : Context): SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        db.execSQL(CREATE_EXERCISES_TABLE_SQL)
